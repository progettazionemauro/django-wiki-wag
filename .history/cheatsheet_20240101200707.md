...
Navigate to the wagtail-wag directory in your terminal.

Assuming there's a requirements.txt file in your Wagtail project (if not, you may need to create one), run:

...
### Copiare directory e sottodirectory di un progetto in maniera sicura ##
`cp -r wiki-wag /home/mauro/Scrivania/django_general_template2/blog_wiki_wag/blog_page_wiki_wag`

Here's a breakdown of the command:

cp: Command for copying files and directories.
-r: Recursively copy directories and their contents.
wiki-wag/blog: Source directory you want to copy.
blog_wiki_wag/blog_page_wiki_wag: Destination directory where you want to copy the contents.
...
## How to recover an accidentally deleted a branch if you remove also a .git direcotry or file ##

If you accidentally deleted the .git directory, it means you lost the Git history and configuration for your repository in that directory. If you have a backup of the repository or if the repository is hosted on GitHub, you can indeed rebuild it. 

If you want to clone a specific branch from a Git repository, you can use the -b option followed by the branch name. In your case, to clone the template-tutorial branch, you can do the following:


`git clone -b template-tutorial https://github.com/progettazionemauro/wiki-wag.git`

If you find some error like this
:::caution
(venv) mauro@mauro-ThinkPad-L460:~/Scrivania/wiki-wag$ git clone -b template-tutorial https://github.com/progettazionemauro/wiki-wag.git
fatal: il percorso di destinazione 'wiki-wag' esiste già e non è una directory vuota.
:::
Better idea is to delete the directories and sub direcotries and after start the clone
